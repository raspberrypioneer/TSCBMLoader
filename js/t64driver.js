...
class t64driver {
    ...
    async getBuffer() {
        ...
        return { protocol: Uint8Array.from([(packetSize == arduino.MAX_BYTES_PER_REQUEST ? 66 /* arduino.Command.BUF_NORMAL */ : 98 /* arduino.Command.BUF_END */), packetSize]), payload: this.subProgBytes.slice(currentPos, currentPos + packetSize) };
    } //getBuffer
